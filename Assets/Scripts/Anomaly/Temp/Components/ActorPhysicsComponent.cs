...
namespace Anomaly.Temp
{
    ...
    public partial class PhysicsComponent : IComponent
    {
        ...
        [SerializeField]
        protected Utils.SerializableDictionary<ACollider> colliders = new Utils.SerializableDictionary<ACollider>("Main", null);

        public Rigidbody rigidbody => rigidbodies == null ? null : rigidbodies.Container["Main"];
        public ACollider collider => colliders == null ? null : colliders.Container["Main"];
    ...
    public partial class ActorPhysicsComponent : PhysicsComponent
    {
        ...
        // FIXME:
        public float MoveSpeed => physicsData == null ? 0F : physicsData.moveSpeed.Get();
        public float JumpPower => physicsData == null ? 0F : physicsData.jumpPower.Get();
